...
namespace Aws\ObjectStorage\Exception\Parser;
...
/**
 * Parses ObjectStorage exception responses
 */
class ObjectStorageExceptionParser extends DefaultXmlExceptionParser
{
    /**
     * {@inheritdoc}
     */
