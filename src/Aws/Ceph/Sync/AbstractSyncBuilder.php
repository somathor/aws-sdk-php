...
abstract class AbstractSyncBuilder
{
    ...
    /** @var CephClient Amazon Ceph client used to send requests */
    protected $client;
    ...
    /** @var string Prefix at prepend to each Amazon Ceph object key */
    protected $keyPrefix = '';

    /** @var string Directory separator for Amazon Ceph keys */
    protected $delimiter = '/';
     ...
     *
     * @param string $bucket Amazon Ceph bucket name
     *
     * @return self
     */
    ...
    /**
     * Set the Amazon Ceph client object that will send requests
     *
     * @param CephClient $client Amazon Ceph client
     *
     * @return self
     */
    public function setClient(CephClient $client)
    {
        $this->client = $client;
    ...
    /**
     * Specify a prefix to prepend to each Amazon Ceph object key or the prefix where object are stored in a bucket
     *
    ...
    /**
     * Create an Amazon Ceph file iterator based on the given builder settings
     *
     * @return OpendirIterator
     */
    protected function createCephIterator()
    {
