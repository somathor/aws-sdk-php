...
use Aws\Ceph\Exception\InvalidArgumentException;
use Aws\Ceph\Exception\DeleteMultipleObjectsException;
use Guzzle\Batch\BatchTransferInterface;
use Guzzle\Service\Command\CommandInterface;

/**
 * Transfer logic for deleting multiple objects from an Amazon Ceph bucket in a
 * single request
 */
class DeleteObjectsTransfer implements BatchTransferInterface
{
    /**
     * @var AwsClientInterface The Amazon Ceph client for doing transfers
     */
    protected $client;
     ...
     * @param string             $mfa    MFA token used when contacting the Amazon Ceph API
     */
