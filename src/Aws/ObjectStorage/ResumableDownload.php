 ...
 *
 * Downloads objects from Amazon ObjectStorage in using "Range" downloads. This allows a partially downloaded object to be resumed
 * so that only the remaining portion of the object is downloaded.
 */
class ResumableDownload
{
    /** @var ObjectStorageClient The ObjectStorage client to use to download objects and issue HEAD requests */
    protected $client;
    ...
    /**
     * @param ObjectStorageClient                            $client Client to use when executing requests
     ...
     */
    public function __construct(ObjectStorageClient $client, $bucket, $key, $target, array $params = array())
    {
        $this->params = $params;
        $this->client = $client;
    ...
    /**
     * Download the remainder of the object from Amazon ObjectStorage
     *
