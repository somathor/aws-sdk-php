...
use Aws\ObjectStorage\Model\Acp;
...
class UploadSyncBuilder extends AbstractSyncBuilder
{
    ...
    /**
     * Set the path that contains files to recursively upload to Amazon ObjectStorage
     *
    ...
    /**
     * Set a glob expression that will match files to upload to Amazon ObjectStorage
     *
    ...
    {
        return $this->createObjectStorageIterator();
    }
