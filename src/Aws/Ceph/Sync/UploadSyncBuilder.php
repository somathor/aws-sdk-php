...
class UploadSyncBuilder extends AbstractSyncBuilder
{
    ...
    /**
     * Set the path that contains files to recursively upload to Amazon Ceph
     *
    ...
    /**
     * Set a glob expression that will match files to upload to Amazon Ceph
     *
    ...
    {
        return $this->createCephIterator();
    }
