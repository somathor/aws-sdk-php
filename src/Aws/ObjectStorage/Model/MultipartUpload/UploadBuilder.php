...
namespace Aws\ObjectStorage\Model\MultipartUpload;
 ...
 * large file or data stream to Amazon ObjectStorage using multipart uploads
 */
class UploadBuilder extends AbstractUploadBuilder
{
    ...
    protected function initiateMultipartUpload()
    {
        ...
        // so that it will be returned when downloading the object from Amazon ObjectStorage
        if ($this->md5) {
