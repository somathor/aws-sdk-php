...
namespace Aws\Ceph\Model\MultipartUpload;
 ...
 * large file or data stream to Amazon Ceph using multipart uploads
 */
class UploadBuilder extends AbstractUploadBuilder
{
    ...
    protected function initiateMultipartUpload()
    {
        ...
        // so that it will be returned when downloading the object from Amazon Ceph
        if ($this->md5) {
