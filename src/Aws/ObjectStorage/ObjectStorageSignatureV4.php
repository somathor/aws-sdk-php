...
/**
 * Amazon ObjectStorage signature version 4 overrides.
 */
class ObjectStorageSignatureV4 extends SignatureV4 implements ObjectStorageSignatureInterface
{
    /**
    ...
    /**
     * Amazon ObjectStorage does not double-encode the path component in the canonical req
     */
