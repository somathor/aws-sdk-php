...
namespace Aws\ObjectStorage\Sync;

use Aws\Common\Exception\RuntimeException;
use Aws\Common\Exception\UnexpectedValueException;
use Aws\Common\Model\MultipartUpload\TransferInterface;
use Aws\ObjectStorage\ObjectStorageClient;
use Aws\ObjectStorage\Iterator\OpendirIterator;
...
abstract class AbstractSyncBuilder
{
    ...
    /** @var ObjectStorageClient Amazon ObjectStorage client used to send requests */
    protected $client;
    ...
    /** @var string Prefix at prepend to each Amazon ObjectStorage object key */
    protected $keyPrefix = '';

    /** @var string Directory separator for Amazon ObjectStorage keys */
    protected $delimiter = '/';
     ...
     *
     * @param string $bucket Amazon ObjectStorage bucket name
     *
     * @return self
     */
    ...
    /**
     * Set the Amazon ObjectStorage client object that will send requests
     *
     * @param ObjectStorageClient $client Amazon ObjectStorage client
     *
     * @return self
     */
    public function setClient(ObjectStorageClient $client)
    {
        $this->client = $client;
    ...
    /**
     * Specify a prefix to prepend to each Amazon ObjectStorage object key or the prefix where object are stored in a bucket
     *
    ...
    /**
     * Create an Amazon ObjectStorage file iterator based on the given builder settings
     *
     * @return OpendirIterator
     */
    protected function createObjectStorageIterator()
    {
