...
use Aws\ObjectStorage\Exception\InvalidArgumentException;
use Aws\ObjectStorage\Exception\DeleteMultipleObjectsException;
use Guzzle\Batch\BatchTransferInterface;
use Guzzle\Service\Command\CommandInterface;

/**
 * Transfer logic for deleting multiple objects from an Amazon ObjectStorage bucket in a
 * single request
 */
class DeleteObjectsTransfer implements BatchTransferInterface
{
    /**
     * @var AwsClientInterface The Amazon ObjectStorage client for doing transfers
     */
    protected $client;
     ...
     * @param string             $mfa    MFA token used when contacting the Amazon ObjectStorage API
     */
