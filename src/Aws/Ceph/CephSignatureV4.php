...
/**
 * Amazon Ceph signature version 4 overrides.
 */
class CephSignatureV4 extends SignatureV4 implements CephSignatureInterface
{
    /**
    ...
    /**
     * Amazon Ceph does not double-encode the path component in the canonical req
     */
