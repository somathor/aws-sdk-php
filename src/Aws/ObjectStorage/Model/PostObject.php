...
namespace Aws\ObjectStorage\Model;
...
/**
 * Encapsulates the logic for getting the data for an ObjectStorage object POST upload form
 */
class PostObject extends Collection
{
    /**
     * @var ObjectStorageClient The ObjectStorage client being used to sign the policy
     */
    protected $client;
     ...
     * - success_action_redirect:      The URI for Amazon ObjectStorage to redirect to upon successful upload
     * - success_action_status:        The status code for Amazon ObjectStorage to return upon successful upload
     ...
     * @param array $options
     */
    public function __construct(ObjectStorageClient $client, $bucket, array $options = array())
    {
    ...
    public function prepareData()
    {
        ...
        $policy = array(
            'expiration' => gmdate(DateFormat::ISO8601_ObjectStorage, $ttd),
