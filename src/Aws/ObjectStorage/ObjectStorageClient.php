...
use Aws\ObjectStorage\Exception\AccessDeniedException;
use Aws\ObjectStorage\Exception\Parser\ObjectStorageExceptionParser;
use Aws\ObjectStorage\Exception\ObjectStorageException;
use Aws\ObjectStorage\Model\ClearBucket;
use Aws\ObjectStorage\Model\MultipartUpload\AbstractTransfer as AbstractMulti;
use Aws\ObjectStorage\Model\MultipartUpload\UploadBuilder;
use Aws\ObjectStorage\Sync\DownloadSyncBuilder;
use Aws\ObjectStorage\Sync\UploadSyncBuilder;
 ...
 *
 * @method ObjectStorageSignatureInterface getSignature() Returns the signature implementation used with the client
 * @method Model abortMultipartUpload(array $args = array()) {@command ObjectStorage AbortMultipartUpload}
 * @method Model completeMultipartUpload(array $args = array()) {@command ObjectStorage CompleteMultipartUpload}
 * @method Model copyObject(array $args = array()) {@command ObjectStorage CopyObject}
 * @method Model createBucket(array $args = array()) {@command ObjectStorage CreateBucket}
 * @method Model createMultipartUpload(array $args = array()) {@command ObjectStorage CreateMultipartUpload}
 * @method Model deleteBucket(array $args = array()) {@command ObjectStorage DeleteBucket}
 * @method Model deleteBucketCors(array $args = array()) {@command ObjectStorage DeleteBucketCors}
 * @method Model deleteBucketLifecycle(array $args = array()) {@command ObjectStorage DeleteBucketLifecycle}
 * @method Model deleteBucketPolicy(array $args = array()) {@command ObjectStorage DeleteBucketPolicy}
 * @method Model deleteBucketTagging(array $args = array()) {@command ObjectStorage DeleteBucketTagging}
 * @method Model deleteBucketWebsite(array $args = array()) {@command ObjectStorage DeleteBucketWebsite}
 * @method Model deleteObject(array $args = array()) {@command ObjectStorage DeleteObject}
 * @method Model deleteObjects(array $args = array()) {@command ObjectStorage DeleteObjects}
 * @method Model getBucketAcl(array $args = array()) {@command ObjectStorage GetBucketAcl}
 * @method Model getBucketCors(array $args = array()) {@command ObjectStorage GetBucketCors}
 * @method Model getBucketLifecycle(array $args = array()) {@command ObjectStorage GetBucketLifecycle}
 * @method Model getBucketLocation(array $args = array()) {@command ObjectStorage GetBucketLocation}
 * @method Model getBucketLogging(array $args = array()) {@command ObjectStorage GetBucketLogging}
 * @method Model getBucketNotification(array $args = array()) {@command ObjectStorage GetBucketNotification}
 * @method Model getBucketPolicy(array $args = array()) {@command ObjectStorage GetBucketPolicy}
 * @method Model getBucketRequestPayment(array $args = array()) {@command ObjectStorage GetBucketRequestPayment}
 * @method Model getBucketTagging(array $args = array()) {@command ObjectStorage GetBucketTagging}
 * @method Model getBucketVersioning(array $args = array()) {@command ObjectStorage GetBucketVersioning}
 * @method Model getBucketWebsite(array $args = array()) {@command ObjectStorage GetBucketWebsite}
 * @method Model getObject(array $args = array()) {@command ObjectStorage GetObject}
 * @method Model getObjectAcl(array $args = array()) {@command ObjectStorage GetObjectAcl}
 * @method Model getObjectTorrent(array $args = array()) {@command ObjectStorage GetObjectTorrent}
 * @method Model headBucket(array $args = array()) {@command ObjectStorage HeadBucket}
 * @method Model headObject(array $args = array()) {@command ObjectStorage HeadObject}
 * @method Model listBuckets(array $args = array()) {@command ObjectStorage ListBuckets}
 * @method Model listMultipartUploads(array $args = array()) {@command ObjectStorage ListMultipartUploads}
 * @method Model listObjectVersions(array $args = array()) {@command ObjectStorage ListObjectVersions}
 * @method Model listObjects(array $args = array()) {@command ObjectStorage ListObjects}
 * @method Model listParts(array $args = array()) {@command ObjectStorage ListParts}
 * @method Model putBucketAcl(array $args = array()) {@command ObjectStorage PutBucketAcl}
 * @method Model putBucketCors(array $args = array()) {@command ObjectStorage PutBucketCors}
 * @method Model putBucketLifecycle(array $args = array()) {@command ObjectStorage PutBucketLifecycle}
 * @method Model putBucketLogging(array $args = array()) {@command ObjectStorage PutBucketLogging}
 * @method Model putBucketNotification(array $args = array()) {@command ObjectStorage PutBucketNotification}
 * @method Model putBucketPolicy(array $args = array()) {@command ObjectStorage PutBucketPolicy}
 * @method Model putBucketRequestPayment(array $args = array()) {@command ObjectStorage PutBucketRequestPayment}
 * @method Model putBucketTagging(array $args = array()) {@command ObjectStorage PutBucketTagging}
 * @method Model putBucketVersioning(array $args = array()) {@command ObjectStorage PutBucketVersioning}
 * @method Model putBucketWebsite(array $args = array()) {@command ObjectStorage PutBucketWebsite}
 * @method Model putObject(array $args = array()) {@command ObjectStorage PutObject}
 * @method Model putObjectAcl(array $args = array()) {@command ObjectStorage PutObjectAcl}
 * @method Model restoreObject(array $args = array()) {@command ObjectStorage RestoreObject}
 * @method Model uploadPart(array $args = array()) {@command ObjectStorage UploadPart}
 * @method Model uploadPartCopy(array $args = array()) {@command ObjectStorage UploadPartCopy}
 ...
 * @link http://docs.aws.amazon.com/aws-sdk-php/latest/class-Aws.ObjectStorage.ObjectStorageClient.html API docs
 */
class ObjectStorageClient extends AbstractClient
{
    ...
    /**
     * @var array Aliases for ObjectStorage operations
     */
    ...
    /**
     * Factory method to create a new Amazon ObjectStorage client using an array of configuration options.
     *
    ...
    {
        $exceptionParser = new ObjectStorageExceptionParser();

        // Configure the custom exponential backoff plugin for retrying ObjectStorage specific errors
        ...
        $client->addSubscriber(new ObjectStorageMd5Listener($signature));
        ...
        // Add aliases for some ObjectStorage operations
    ...
    /**
     * Create an Amazon ObjectStorage specific backoff plugin
     *
     * @param ObjectStorageExceptionParser $exceptionParser
     *
     * @return BackoffPlugin
     */
    private static function createBackoffPlugin(ObjectStorageExceptionParser $exceptionParser)
    {
    ...
    private static function createSignature($config)
    {
        ...
        // Use the Amazon ObjectStorage signature V4 when the value is set to "v4" or when
        ...
        if ($currentValue == 'v4' || $requiresV4) {
            ...
            $currentValue = new ObjectStorageSignatureV4('s3');
        } elseif (!$currentValue || $currentValue == 's3') {
            // Use the Amazon ObjectStorage signature by default
            $currentValue = new ObjectStorageSignature();
        }
    ...
    /**
     * Determine if a string is a valid name for a DNS compatible Amazon ObjectStorage
    ...
    /**
     * Register the Amazon ObjectStorage stream wrapper and associates it with this client object
     *
     * @return self
     */
     ...
     *
     * @see Aws\ObjectStorage\Model\MultipartUpload\UploadBuilder for more options and customization
     ...
     *     - force: Set to true to upload every file, even if the file is already in Amazon ObjectStorage and has not changed
     ...
     *       multipart upload.
     *
     * @see Aws\ObjectStorage\ObjectStorageSync\ObjectStorageSync for more options and customization
     */
    ...
    /**
     * Deletes objects from Amazon ObjectStorage that match the result of a ListObjects operation. For example, this allows you
     ...
     *       Guzzle\Common\Event object with context.
     *
     * @see Aws\ObjectStorage\ObjectStorageClient::listObjects
     * @see Aws\ObjectStorage\Model\ClearBucket For more options or customization
     * @return int Returns the number of deleted keys
    ...
    {
        if (!$prefix && !$regex) {
            throw new RuntimeException('A prefix or regex is required, or use ObjectStorageClient::clearBucket().');
        }
     ...
     *
     * @return bool
     * @throws ObjectStorageException|\Exception if there is an unhandled exception
     */
