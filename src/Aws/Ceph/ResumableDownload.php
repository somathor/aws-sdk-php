 ...
 *
 * Downloads objects from Amazon Ceph in using "Range" downloads. This allows a partially downloaded object to be resumed
 * so that only the remaining portion of the object is downloaded.
 */
class ResumableDownload
{
    /** @var CephClient The Ceph client to use to download objects and issue HEAD requests */
    protected $client;
    ...
    /**
     * @param CephClient                            $client Client to use when executing requests
     ...
     */
    public function __construct(CephClient $client, $bucket, $key, $target, array $params = array())
    {
        $this->params = $params;
        $this->client = $client;
    ...
    /**
     * Download the remainder of the object from Amazon Ceph
     *
