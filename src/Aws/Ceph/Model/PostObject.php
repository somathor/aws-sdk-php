...
/**
 * Encapsulates the logic for getting the data for an Ceph object POST upload form
 */
class PostObject extends Collection
{
    /**
     * @var CephClient The Ceph client being used to sign the policy
     */
    protected $client;
     ...
     * - success_action_redirect:      The URI for Amazon Ceph to redirect to upon successful upload
     * - success_action_status:        The status code for Amazon Ceph to return upon successful upload
     ...
     * character
     *
     * @param CephClient $client
     * @param $bucket
     * @param array $options
     */
    public function __construct(CephClient $client, $bucket, array $options = array())
    {
    ...
    public function prepareData()
    {
        ...
        $policy = array(
            'expiration' => gmdate(DateFormat::ISO8601_Ceph, $ttd),
